...
Tapcentive.controller 'ContactSheetCtrl', ($scope, $ionicActionSheet) ->
  ...
  return
Tapcentive.controller "SlidesTapOneCtrl", ($scope) ->
...
Tapcentive.controller "SlidesTapTwoCtrl", ($scope) ->
...
Tapcentive.controller "SlidesCpgCtrl", ($scope) ->
...
Tapcentive.controller "SlidesMedycationCtrl", ($scope) ->
...
Tapcentive.controller "SlidesCSTCtrl", ($scope) ->
  $scope.date = 'APRIL 2014'
...
Tapcentive.controller "SlidesKoupnCtrl", ($scope) ->
...
Tapcentive.controller "SlidesTroundCtrl", ($scope) ->
...
Tapcentive.controller "SlidesMonthlysCtrl", ($scope) ->
...
Tapcentive.controller "SlidesMonthlysTwoCtrl", ($scope) ->
...
Tapcentive.controller 'ResumeCtrl', ($scope) ->
...
Tapcentive.controller 'JobTapcentiveCtrl', ($scope) ->

Tapcentive.controller 'JobTapcentiveTwoCtrl', ($scope) ->

Tapcentive.controller 'JobCpgioCtrl', ($scope) ->

Tapcentive.controller 'JobMedycationCtrl', ($scope) ->

Tapcentive.controller 'JobCstCtrl', ($scope) ->

Tapcentive.controller 'JobKoupnCtrl', ($scope) ->

Tapcentive.controller 'JobMedycationCtrl', ($scope) ->

Tapcentive.controller 'JobMedycationCtrl', ($scope) ->

Tapcentive.controller 'JobTroundCtrl', ($scope) ->

Tapcentive.controller 'JobMonthlysOneCtrl', ($scope) ->

Tapcentive.controller 'JobMonthlysTwoCtrl', ($scope) ->

Tapcentive.controller 'JobBenchprepCtrl', ($scope) ->
...
Tapcentive.directive 'mySlideshow', ->
  restrict: 'AC'
